...
part of 'produto_generico_abstact_controller.dart';
...
mixin _$ProdutoGenericoAbstractController
    on ProdutoGenericoAbstractControllerBase, Store {
  late final _$tipoBotaoMenusAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.tipoBotaoMenus',
      context: context);
  ...
  late final _$produtoCarrinhoAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.produtoCarrinho',
      context: context);
  ...
  late final _$produtoMenuAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.produtoMenu',
      context: context);
  ...
  late final _$proximoMenuAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.proximoMenu',
      context: context);
  ...
  late final _$anteriorMenuAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.anteriorMenu',
      context: context);
  ...
  late final _$menuAtom = Atom(
      name: 'ProdutoGenericoAbstractControllerBase.menu', context: context);
  ...
  late final _$ProdutoGenericoAbstractControllerBaseActionController =
      ActionController(
          name: 'ProdutoGenericoAbstractControllerBase', context: context);

  @override
  void atualizaMenus(int index) {
    final _$actionInfo =
        _$ProdutoGenericoAbstractControllerBaseActionController.startAction(
            name: 'ProdutoGenericoAbstractControllerBase.atualizaMenus');
    try {
      return super.atualizaMenus(index);
    } finally {
      _$ProdutoGenericoAbstractControllerBaseActionController
  ...
  void atualizaTipoBotaoMenus(
    ...
    final _$actionInfo =
        _$ProdutoGenericoAbstractControllerBaseActionController.startAction(
            name:
                'ProdutoGenericoAbstractControllerBase.atualizaTipoBotaoMenus');
    try {
