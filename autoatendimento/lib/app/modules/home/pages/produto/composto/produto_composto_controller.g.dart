...
part of 'produto_composto_controller.dart';
...
mixin _$ProdutoCompostoController on ProdutoCompostoBase, Store {
  late final _$produtoCarrinhoAtom =
      Atom(name: 'ProdutoCompostoBase.produtoCarrinho', context: context);
  ...
  late final _$produtoMenuAtom =
      Atom(name: 'ProdutoCompostoBase.produtoMenu', context: context);
  ...
  late final _$proximoMenuAtom =
      Atom(name: 'ProdutoCompostoBase.proximoMenu', context: context);
  ...
  late final _$anteriorMenuAtom =
      Atom(name: 'ProdutoCompostoBase.anteriorMenu', context: context);
  ...
  late final _$radiovalueAtom =
      Atom(name: 'ProdutoCompostoBase.radiovalue', context: context);
  ...
  late final _$menuAtom =
      Atom(name: 'ProdutoCompostoBase.menu', context: context);
  ...
  late final _$ProdutoCompostoBaseActionController =
      ActionController(name: 'ProdutoCompostoBase', context: context);

  @override
  dynamic setarCarrinhoOriginal(ProdutoCarrinho original) {
    final _$actionInfo = _$ProdutoCompostoBaseActionController.startAction(
        name: 'ProdutoCompostoBase.setarCarrinhoOriginal');
    try {
      return super.setarCarrinhoOriginal(original);
    } finally {
      _$ProdutoCompostoBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void _changeNotaItemMenu() {
    final _$actionInfo = _$ProdutoCompostoBaseActionController.startAction(
        name: 'ProdutoCompostoBase._changeNotaItemMenu');
    try {
  ...
  void selecaoRadio(int n) {
    final _$actionInfo = _$ProdutoCompostoBaseActionController.startAction(
        name: 'ProdutoCompostoBase.selecaoRadio');
    try {
  ...
  void changeProdutoCarrinho(ProdutoCarrinho value) {
    final _$actionInfo = _$ProdutoCompostoBaseActionController.startAction(
        name: 'ProdutoCompostoBase.changeProdutoCarrinho');
    try {
