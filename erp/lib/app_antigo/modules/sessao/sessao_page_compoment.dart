import 'package:erp/app_antigo/modules/sessao/sessao_controller.dart';
import 'package:erp/app_antigo/widgets/confirmation_dialog.dart';
import 'package:erp/app_antigo/widgets/data_table/data_table_custom.dart';
import 'package:erp/app_antigo/widgets/data_table/models/row_custom.dart';
import 'package:erp/app_antigo/widgets/confirmation_dialog.dart';
...
import '../../widgets/data_table/data_table_custom.dart';
import '../../widgets/data_table/models/row_custom.dart';
    ...
    return DataTableCustom<DadosSessaoDTO>(
        ...
        rows: controller.dadosSessoes
            .map((d) => [
                  ...
                  RowCustom(child: Text(d.tipoClient!.descricao), object: d),
                  RowCustom(
                      child: Text(
