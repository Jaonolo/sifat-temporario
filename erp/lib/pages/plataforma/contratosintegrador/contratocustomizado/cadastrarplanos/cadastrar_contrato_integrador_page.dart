...
class CadastrarContratoIntegradorPage extends GetView<CadastrarContratoIntegradorController> {
// class ContratosIntegradorPage extends StatelessWidget {
  const CadastrarContratoIntegradorPage({Key? key}) : super(key: key);
